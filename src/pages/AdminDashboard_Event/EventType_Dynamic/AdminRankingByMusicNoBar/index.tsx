...
interface AdminRankingByMusicNoBarProps {}
...
const AdminRankingByMusicNoBar: FunctionComponent<
  AdminRankingByMusicNoBarProps
> = () => {
...
export default AdminRankingByMusicNoBar;
