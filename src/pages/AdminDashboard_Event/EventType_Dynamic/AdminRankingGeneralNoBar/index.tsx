...
interface AdminGeneralRankingNoBarProps {}
...
const AdminGeneralRankingNoBar: FunctionComponent<AdminGeneralRankingNoBarProps> = () => {
...
export default AdminGeneralRankingNoBar;
