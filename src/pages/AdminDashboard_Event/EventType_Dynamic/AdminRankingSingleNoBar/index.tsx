...
interface  AdminSingleRankingNoBarProps {}
...
const  AdminSingleRankingNoBar: FunctionComponent< AdminSingleRankingNoBarProps> = () => {
...
export default  AdminSingleRankingNoBar;
