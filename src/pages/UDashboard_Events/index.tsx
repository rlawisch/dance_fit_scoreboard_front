...
interface UDashboardEventsProps {}

const UDashboardEvents: FunctionComponent<UDashboardEventsProps> = () => {
            ...
            {events.map((event) => (
              <tr key={event.event_id}>
                <td>
                  ...
                  <Button
                    onClick={() =>
                      navigate(`/udashboard/events/${event.event_id}`)
                    }
                  >
                    <AiOutlineArrowRight />
                  </Button>
...
export default UDashboardEvents;
