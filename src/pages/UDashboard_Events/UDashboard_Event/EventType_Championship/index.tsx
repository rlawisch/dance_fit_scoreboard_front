...
interface UEventType_ChampionshipProps {}

const UEventType_Championship: FunctionComponent<
  UEventType_ChampionshipProps
> = () => {
          ...
          <tr>
            <TableHeader>
              <TableHeaderWrapper>
                ...
                {isAdmin() && (
                  <>
                    <UpdateButton onClick={openCategoryCreateModal}>
                      +
                    </UpdateButton>
                  </>
                )}
                    ...
                    <TableDataWrapper>
                      ...
                      <div>
                        <Button
                          onClick={() =>
                            navigate(
                              `/udashboard/events/${event_id}/categories/${category.category_id}`
                            )
                          }
                        >
                          <AiOutlineArrowRight />
...
export default UEventType_Championship;
