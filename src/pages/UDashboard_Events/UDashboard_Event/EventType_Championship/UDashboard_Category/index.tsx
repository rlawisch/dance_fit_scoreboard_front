...
interface UDashboardCategoryProps {}

const UDashboardCategory: FunctionComponent<UDashboardCategoryProps> = () => {
  ...
  return (
    <GlobalContainer>
      <Button onClick={() => navigate(`/udashboard/events/${event_id}`)}>
        Voltar
      </Button>
                    ...
                    <TableDataWrapper>
                      ...
                      {isAdmin() && (
                        <>
                          ...
                          <Modal
                            isOpen={isCategoryAdmRemovePlayerModalOpen(
                              p.player_id
                            )}
                            onClose={() =>
...
export default UDashboardCategory;
