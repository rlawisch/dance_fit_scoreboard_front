...
interface PublicRankingByMusicNoBarProps {}
...
const PublicRankingByMusicNoBar: FunctionComponent<
  PublicRankingByMusicNoBarProps
> = () => {
...
export default PublicRankingByMusicNoBar;
