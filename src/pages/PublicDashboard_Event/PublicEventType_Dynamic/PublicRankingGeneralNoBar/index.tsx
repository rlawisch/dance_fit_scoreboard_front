...
interface PublicRankingGeneralNoBarProps {}
...
const PublicRankingGeneralNoBar: FunctionComponent<
  PublicRankingGeneralNoBarProps
> = () => {
...
export default PublicRankingGeneralNoBar;
