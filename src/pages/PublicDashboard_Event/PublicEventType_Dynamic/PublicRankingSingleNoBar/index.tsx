...
interface PublicRankingSingleNoBarProps {}
...
const PublicRankingSingleNoBar: FunctionComponent<PublicRankingSingleNoBarProps> = () => {
...
export default PublicRankingSingleNoBar;
