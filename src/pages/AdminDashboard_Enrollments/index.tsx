...
interface AdminDashboard_EnrollmentsProps {}

const AdminDashboard_Enrollments: FunctionComponent<
  AdminDashboard_EnrollmentsProps
> = () => {
...
export default AdminDashboard_Enrollments;
